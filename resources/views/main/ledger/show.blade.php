        ...
        <div>
                ...
                <div class="card-body p-0 px-1">
                    <div class="row">
                        ...
                        <div class="col-3">
                            <div class="mb-1">
                                <label
                                    class="form-label">{{ __('locale.Date') }}</label>
            ...
            <div class="card mb-1">
                <ul class="nav nav-tabs px-1" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link w-100" data-bs-toggle="tab"
                            href="#list_items" aria-controls="list_items"
                            role="tab">
                            {{ __('locale.List') }}
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link w-100 active" data-bs-toggle="tab"
                            href="#new_items" aria-controls="new_items"
                            role="tab">
                            {{ __('locale.New') }}
                        </a>
                    </li>
                ...
                <div class="tab-content">
                    <div id="list_items" class="tab-pane ">
                        <div class="card">
                            <div
                                class="card-header p-1 d-flex justify-content-between">
                                <h4 class="m-0">
                                    {{ __('locale.List') }}
                                </h4>
                            </div>
                    ...
                    <div id="new_items" class="tab-pane active"
                        ...
                        <div class="items-repeater">
                            <button type="button" data-repeater-create hidden
                                class="btn-addRow"></button>
                            <div class="card mb-1">
                                <div
                                    class="card-header p-1 d-flex justify-content-between">
                                    <h4 class="m-0">
                                    ...
                                    <table class="table table-sm mb-1">
                                        <thead class="">
                                            <tr>
                                                ...
                                                <th>{{ __('locale.Account') }}</th>
                                                <th>{{ __('locale.Unit') }}</th>
                                                <th>{{ __('locale.Quantity') }}
                                                </th>
                                                <th>{{ __('locale.Note') }}</th>
                                                <th>{{ __('locale.Options') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody data-repeater-list="ledger_items"
                                            id="ledger_items_list"
                                            onkeydown="
                                            if(event.which == 13) {
                                                event.preventDefault();
                                            }">
                                                ...
                                                x-data="{
                                                    ...
                                                    updateBalance($event) {
                                                        if (this.type === 'debit') {
                                                            ...
                                                            this.changed_balanced -= Number(this.quantity);
                                                        } else if (this.type === 'credit') {
                                                            this.changed_balanced -= Number(this.stored_quantity);
                                                            this.changed_balanced += Number(this.quantity);
                                                        } else {
                                                        ...
                                                        this.stored_quantity = this.quantity
                                                    }
                                                }">
                                                <td id="first">
                                                    <select name="type"
                                                        x-model="type"
                                                        class="form-select"
                                                        x-init="$watch('type', value => setAccounts(value))">
                                                        <option value="">
                                                            {{ __('locale.Chose') }}
                                                        </option>
                                                        <option value="debit">
                                    ...
                                    <table class="table table-sm mb-1 ">
                                        <tbody class="table-hover">
                                            <tr
                                                ...
                                                <th>{{ __('locale.Base Balance') }}
                                                </th>
                                                <th>{{ $ledger->end_balance }}</th>
                                                <th>{{ __('locale.changed Balance') }}
                                                </th>
