...
@section('title')
    {{ __('locale.New AccountType') }}
@endsection

@section('content')
    <section>
        <form method="POST" action="{{ route('accountType.store') }}" class="form form-vertical">
            @csrf
            <div class="card row">
                @if ($errors->any())
                ...
                <div class="card-header">
                    <h4 class="card-title">{{ __('locale.New AccountType') }}</h4>
                </div>
                <div class="card-body types-repeater">
