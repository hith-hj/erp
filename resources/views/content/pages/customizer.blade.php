...
<div class="customizer d-none d-md-block">
    ...
    <div class="customizer-content">
        ...
        <div class="customizer-header px-2 pt-1 pb-0 position-relative">
            ...
            <p class="m-0">Customize & Preview in Real Time Hit save when done to make it permenant</p>
        ...
        <hr />
        <form action="{{ route('themeCustomizer') }}" method="POST">
            <input type="hidden" name="skinColor" id="skinColor" required>
            <input type="hidden" name="navColor" id="navColor" required>
            <input type="hidden" name="navType" id="navType" required>
            @csrf
            <button type="submit" class="btn btn-sm btn-primary w-75 mx-1">Save Changes</button>
        </form>
