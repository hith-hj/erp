<?php $__env->startSection('title', 'User View - Security'); ?>
  ...
  <div class="row">
    ...
    <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
      ...
      <ul class="nav nav-pills mb-2">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="<?php echo e(asset('app/user/view/security')); ?>">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo e(asset('app/user/view/connections')); ?>">
              ...
              <tr>
                <td class="text-start">
                  <div class="avatar me-25">
                    <img src="<?php echo e(asset('images/icons/google-chrome.png')); ?>" alt="avatar" width="20" height="20" />
                  </div>
...
<?php $__env->startSection('page-script'); ?>
  ...
  <script src="<?php echo e(asset(mix('js/scripts/pages/app-user-view-security.js'))); ?>"></script>
  <script src="<?php echo e(asset(mix('js/scripts/pages/app-user-view.js'))); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views//content/apps/user/app-user-view-security.blade.php ENDPATH**/ ?>