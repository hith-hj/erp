...
<section id="card-demo-example">
  <div class="row match-height">
    <div class="col-md-6 col-lg-4">
      <div class="card">
        <img class="card-img-top" src="<?php echo e(asset('images/slider/04.jpg')); ?>" alt="Card image cap" />
        <div class="card-body">
    ...
    <div class="col-md-6 col-lg-4">
      <div class="card">
        ...
        <img class="img-fluid" src="<?php echo e(asset("images/slider/03.jpg")); ?>" alt="Card image cap" />
        <div class="card-body">
    ...
    <div class="col-md-6 col-lg-4">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Card title</h4>
          <h6 class="card-subtitle text-muted">Support card subtitle</h6>
          <img class="img-fluid my-2" src="<?php echo e(asset('images/slider/06.jpg')); ?>" alt="Card image cap" />
          <p class="card-text">Bear claw sesame snaps gummies chocolate.</p>
          <a href="#" class="card-link">Card link</a>
          <a href="#" class="card-link">Another link</a>
        </div>
...
<section id="card-content-types">
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-lg-4">
      ...
      <div class="card mb-4">
        <img class="card-img-top" src="<?php echo e(asset('images/slider/01.jpg')); ?>" alt="Card image cap" />
        <div class="card-body">
          <p class="card-text">
            Some quick example text to build on the card title and make up the bulk of the card's content.
          </p>
    ...
    <div class="col-md-6 col-lg-4">
      ...
      <div class="card">
        <img class="card-img-top" src="<?php echo e(asset('images/slider/02.jpg')); ?>" alt="Card image cap" />
        <div class="card-body">
          <h4 class="card-title">Card title</h4>
...
<section id="card-images">
  ...
  <div class="row">
    <div class="col-md-6 col-xl-4">
      <div class="card mb-3">
        <img class="card-img-top" src="<?php echo e(asset('images/slider/06.jpg')); ?>" alt="Card image cap" />
        <div class="card-body">
          <h4 class="card-title">Card title</h4>
          <p class="card-text">
    ...
    <div class="col-md-6 col-xl-4">
      <div class="card mb-3">
        ...
        <img class="card-img-bottom" src="<?php echo e(asset('images/slider/09.jpg')); ?>" alt="Card image cap" />
      </div>
    </div>
    <div class="col-md-6 col-xl-4">
      <div class="card border-0 text-white">
        <img class="card-img" src="<?php echo e(asset('images/slider/10.jpg')); ?>" alt="Card image" />
...
<section class="card-layout">
  ...
  <div class="card-group">
    ...
    <div class="card">
      <img class="card-img-top" src="<?php echo e(asset('images/slider/05.jpg')); ?>" alt="Card image cap" />
      <div class="card-body">
        <h4 class="card-title">Card title</h4>
    ...
    <div class="card">
      <img class="card-img-top" src="<?php echo e(asset('images/slider/03.jpg')); ?>" alt="Card image cap" />
      <div class="card-body">
        <h4 class="card-title">Card title</h4>
        <p class="card-text">
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views//content/cards/card-basic.blade.php ENDPATH**/ ?>