...
<div class="toast-container position-fixed top-0 end-0 p-2" style="z-index: 15">
  <div class="toast toast-autohide hide" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
    <div class="toast-header">
      <img src="<?php echo e(asset('images/logo/logo.png')); ?>" class="me-1" alt="Toast Image" height="18" width="25" />
      <strong class="me-auto">Vue Admin</strong>
...
<?php $__env->startSection('page-script'); ?>
  <script src="<?php echo e(asset(mix('js/scripts/components/components-bs-toast.js'))); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views//content/components/component-bs-toast.blade.php ENDPATH**/ ?>