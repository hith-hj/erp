<?php $__env->startSection('title', 'User View - Notifications'); ?>
  ...
  <div class="row">
    ...
    <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
      ...
      <ul class="nav nav-pills mb-2">
        <li class="nav-item">
          <a class="nav-link" href="<?php echo e(asset('app/user/view/account')); ?>">
            <i data-feather="user" class="font-medium-3 me-50"></i>
            <span class="fw-bold">Account</span></a
          >
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo e(asset('app/user/view/security')); ?>">
            <i data-feather="lock" class="font-medium-3 me-50"></i>
            <span class="fw-bold">Security</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo e(asset('app/user/view/billing')); ?>">
            <i data-feather="bookmark" class="font-medium-3 me-50"></i>
            <span class="fw-bold">Billing & Plans</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo e(asset('app/user/view/notifications')); ?>">
            <i data-feather="bell" class="font-medium-3 me-50"></i><span class="fw-bold">Notifications</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="<?php echo e(asset('app/user/view/connections')); ?>">
        ...
        <div class="card-body">
          ...
          <div class="d-flex mt-2">
            <div class="flex-shrink-0">
              <img
                src="<?php echo e(asset('images/icons/social/google.png')); ?>"
                alt="google"
                class="me-1"
                height="38"
                width="38"
          ...
          <div class="d-flex mt-2">
            <div class="flex-shrink-0">
              <img
                src="<?php echo e(asset('images/icons/social/slack.png')); ?>"
                alt="slack"
                class="me-1"
                height="38"
                width="38"
          ...
          <div class="d-flex mt-2">
            <div class="flex-shrink-0">
              <img
                src="<?php echo e(asset('images/icons/social/github.png')); ?>"
                alt="github"
                class="me-1"
                height="38"
                width="38"
          ...
          <div class="d-flex mt-2">
            <div class="flex-shrink-0">
              <img
                src="<?php echo e(asset('images/icons/social/mailchimp.png')); ?>"
                alt="mailchimp"
                class="me-1"
                height="38"
                width="38"
          ...
          <div class="d-flex mt-2">
            <div class="flex-shrink-0">
              <img
                src="<?php echo e(asset('images/icons/social/asana.png')); ?>"
                alt="asana"
                class="me-1"
                height="38"
                width="38"
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="d-flex mt-2">
            <div class="flex-shrink-0">
              <img
                src="<?php echo e(asset('images/icons/social/facebook.png')); ?>"
                alt="facebook"
                class="me-1"
                height="38"
                width="38"
          ...
          <div class="d-flex align-items-start mt-2">
            <div class="flex-shrink-0">
              <img
                src="<?php echo e(asset('images/icons/social/twitter.png')); ?>"
                alt="twitter"
                class="me-1"
                height="38"
                width="38"
          ...
          <div class="d-flex mt-2">
            <div class="flex-shrink-0">
              <img
                src="<?php echo e(asset('images/icons/social/linkedin.png')); ?>"
                alt="instagram"
                class="me-1"
                height="38"
                width="38"
          ...
          <div class="d-flex mt-2">
            <div class="flex-shrink-0">
              <img
                src="<?php echo e(asset('images/icons/social/dribbble.png')); ?>"
                alt="dribbble"
                class="me-1"
                height="38"
                width="38"
          ...
          <div class="d-flex mt-2">
            <div class="flex-shrink-0">
              <img
                src="<?php echo e(asset('images/icons/social/behance.png')); ?>"
                alt="behance"
                class="me-1"
                height="38"
                width="38"
...
<?php echo $__env->make('content/_partials/_modals/modal-edit-user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('content/_partials/_modals/modal-upgrade-plan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('page-script'); ?>
  ...
  <script src="<?php echo e(asset(mix('js/scripts/pages/app-user-view.js'))); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views//content/apps/user/app-user-view-connections.blade.php ENDPATH**/ ?>