...
<?php $__env->startSection('vendor-style'); ?>
  <!-- Vendor css files -->
  <link rel="stylesheet" href="<?php echo e(asset(mix('vendors/css/calendars/fullcalendar.min.css'))); ?>">
...
<?php $__env->startSection('page-style'); ?>
  ...
  <link rel="stylesheet" href="<?php echo e(asset(mix('css/base/pages/app-calendar.css'))); ?>">
  ...
  <div class="app-calendar overflow-hidden border">
    <div class="row g-0">
      ...
      <div class="col app-calendar-sidebar flex-grow-0 overflow-hidden d-flex flex-column" id="app-calendar-sidebar">
        ...
        <div class="mt-auto">
          <img
            src="<?php echo e(asset('images/pages/calendar-illustration.png')); ?>"
...
<?php $__env->startSection('vendor-script'); ?>
  <!-- Vendor js files -->
  <script src="<?php echo e(asset(mix('vendors/js/calendar/fullcalendar.min.js'))); ?>"></script>
...
<?php $__env->startSection('page-script'); ?>
  <!-- Page js files -->
  <script src="<?php echo e(asset(mix('js/scripts/pages/app-calendar-events.js'))); ?>"></script>
  <script src="<?php echo e(asset(mix('js/scripts/pages/app-calendar.js'))); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views//content/apps/calendar/app-calendar.blade.php ENDPATH**/ ?>