        ...
        <ul class="list-group list-group-flush mb-2">
          <li class="list-group-item d-flex align-items-start border-0 px-0">
            <div class="avatar me-75">
              <img src="<?php echo e(asset('images/portrait/small/avatar-s-9.jpg')); ?>" alt="avatar" width="38" height="38" />
            </div>
          ...
          <li class="list-group-item d-flex align-items-start border-0 px-0">
            <div class="avatar me-75">
              <img src="<?php echo e(asset('images/portrait/small/avatar-s-3.jpg')); ?>" alt="avatar" width="38" height="38" />
            </div>
            <div class="d-flex align-items-center justify-content-between w-100">
              <div class="me-1">
          ...
          <li class="list-group-item d-flex align-items-start border-0 px-0">
            <div class="avatar me-75">
              <img src="<?php echo e(asset('images/portrait/small/avatar-s-5.jpg')); ?>" alt="avatar" width="38" height="38" />
            </div>
            <div class="d-flex align-items-center justify-content-between w-100">
              <div class="me-1">
          ...
          <li class="list-group-item d-flex align-items-start border-0 px-0">
            <div class="avatar me-75">
              <img src="<?php echo e(asset('images/portrait/small/avatar-s-7.jpg')); ?>" alt="avatar" width="38" height="38" />
            </div>
            <div class="d-flex align-items-center justify-content-between w-100">
              <div class="me-1">
          ...
          <li class="list-group-item d-flex align-items-start border-0 px-0">
            <div class="avatar me-75">
              <img src="<?php echo e(asset('images/portrait/small/avatar-s-8.jpg')); ?>" alt="avatar" width="38" height="38" />
            </div>
            <div class="d-flex align-items-center justify-content-between w-100">
              <div class="me-1">
          ...
          <li class="list-group-item d-flex align-items-start border-0 px-0">
            <div class="avatar me-75">
              <img src="<?php echo e(asset('images/portrait/small/avatar-s-6.jpg')); ?>" alt="avatar" width="38" height="38" />
            </div>
            <div class="d-flex align-items-center justify-content-between w-100">
              <div class="me-1">
...
<!-- / share project modal -->
<?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views/content/_partials/_modals/modal-share-project.blade.php ENDPATH**/ ?>