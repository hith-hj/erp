              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item border-0 px-0">
                  <label for="createAppReactNative" class="d-flex cursor-pointer">
                    <span class="avatar avatar-tag bg-light-info me-1">
                      <img src="<?php echo e(asset('images/icons/technology/react.png')); ?>" height="25" alt="react" />
                    </span>
                    <span class="d-flex align-items-center justify-content-between flex-grow-1">
                      <span class="me-1">
                ...
                <li class="list-group-item border-0 px-0">
                  <label for="createAppAngular" class="d-flex cursor-pointer">
                    <span class="avatar avatar-tag bg-light-danger me-1">
                      <img src="<?php echo e(asset('images/icons/technology/angular.png')); ?>" height="25" alt="angular" />
                    </span>
                    <span class="d-flex align-items-center justify-content-between flex-grow-1">
                      <span class="me-1">
                ...
                <li class="list-group-item border-0 px-0">
                  <label for="createAppVue" class="d-flex cursor-pointer">
                    <span class="avatar avatar-tag bg-light-success me-1">
                      <img src="<?php echo e(asset('images/icons/technology/vue.png')); ?>" height="25" alt="vue" />
                    </span>
                    <span class="d-flex align-items-center justify-content-between flex-grow-1">
                      <span class="me-1">
                ...
                <li class="list-group-item border-0 px-0">
                  <label for="createAppLaravel" class="d-flex cursor-pointer">
                    <span class="avatar avatar-tag bg-light-warning me-1">
                      <img src="<?php echo e(asset('images/icons/technology/laravel.png')); ?>" height="25" alt="laravel" />
                    </span>
                    <span class="d-flex align-items-center justify-content-between flex-grow-1">
                      <span class="me-1">
              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item border-0 px-0">
                  <label for="createAppFirebase" class="d-flex cursor-pointer">
                    <span class="avatar avatar-tag bg-light-danger me-1">
                      <img src="<?php echo e(asset('images/icons/google.png')); ?>" height="25" alt="google" />
                    </span>
                    <span class="d-flex align-items-center justify-content-between flex-grow-1">
                      <span class="me-1">
                ...
                <li class="list-group-item border-0 px-0">
                  <label for="createAppDynamoDB" class="d-flex cursor-pointer">
                    <span class="avatar avatar-tag bg-light-secondary me-1">
                      <img src="<?php echo e(asset('images/icons/amazon.png')); ?>" height="25" alt="amazon" />
                    </span>
                    <span class="d-flex align-items-center justify-content-between flex-grow-1">
                      <span class="me-1">
                ...
                <li class="list-group-item border-0 px-0">
                  <label for="createAppMysql" class="d-flex cursor-pointer">
                    <span class="avatar avatar-tag bg-light-info me-1">
                      <img src="<?php echo e(asset('images/icons/database.png')); ?>" height="25" alt="database" />
                    </span>
                    <span class="d-flex align-items-center justify-content-between flex-grow-1">
                      <span class="me-1">
...
<!-- / create app modal -->
<?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views/content/_partials/_modals/modal-create-app.blade.php ENDPATH**/ ?>