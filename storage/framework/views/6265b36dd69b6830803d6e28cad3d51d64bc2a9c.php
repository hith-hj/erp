<?php $__env->startSection('title', 'Collapse'); ?>
        ...
        <div class="card-body">
          ...
          <div class="collapse" id="collapseExample">
            <div class="d-flex p-1 border">
              <img src="<?php echo e(asset('images/slider/04.jpg')); ?>" alt="collapse-image" height="125" class="me-2" />
              <span>
          ...
          <div class="row">
            <div class="col-lg">
              <div class="collapse multi-collapse" id="multiCollapseExample1">
                <div class="d-flex p-1 border">
                  <img src="<?php echo e(asset('images/slider/06.jpg')); ?>" alt="collapse-image" height="125" class="me-2" />
                  <span>
            ...
            <div class="col-lg">
              <div class="collapse multi-collapse mt-lg-0 mt-1" id="multiCollapseExample2">
                <div class="d-flex p-1 border">
                  <img src="<?php echo e(asset('images/slider/08.jpg')); ?>" alt="collapse-image" height="125" class="me-2" />
                  <span>
          ...
          <div class="height-150 mt-2">
            <div class="collapse collapse-horizontal show" id="collapseWidthExample">
              <div class="d-flex width-300 border p-1">
                <img
                  src="<?php echo e(asset('images/slider/08.jpg')); ?>"
                  alt="collapse-image"
                  width="100"
                  height="100"
                  class="me-1"
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views//content/components/component-collapse.blade.php ENDPATH**/ ?>