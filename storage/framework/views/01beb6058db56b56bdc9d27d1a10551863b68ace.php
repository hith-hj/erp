...
<div class="navbar-container d-flex content">
    <div class="bookmark-wrapper d-flex align-items-center">
        ...
        <ul class="nav navbar-nav bookmark-icons">
            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="<?php echo e(url('app/email')); ?>"
                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="Email"><i class="ficon"
                        data-feather="mail"></i></a></li>
            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="<?php echo e(url('app/chat')); ?>"
                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="Chat"><i class="ficon"
                        data-feather="message-square"></i></a></li>
            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="<?php echo e(url('app/calendar')); ?>"
                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="Calendar"><i class="ficon"
                        data-feather="calendar"></i></a></li>
            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="<?php echo e(url('app/todo')); ?>"
    ...
    <ul class="nav navbar-nav align-items-center ms-auto">
        <li class="nav-item dropdown dropdown-language">
            ...
            <div class="dropdown-menu dropdown-menu-end " aria-labelledby="dropdown-flag">
                <a class="dropdown-item <?php echo e(session()->get('locale') == 'ar' ? '' : 'active'); ?>"
                    href="<?php echo e(url('lang/en')); ?>" data-language="en">
                    <i class="flag-icon flag-icon-us"></i> English
                </a>
                <a class="dropdown-item <?php echo e(session()->get('locale') == 'ar' ? 'active' : ''); ?>"
                    href="<?php echo e(url('lang/ar')); ?>" data-language="pt">
                    <i class="flag-icon flag-icon-sy"></i> <?php echo e(__('locale.Arabic')); ?>
        ...
        <li class="nav-item d-none d-lg-block">
            <a class="nav-link nav-link-style">
                <i class="ficon" data-feather="<?php echo e($configData['theme'] === 'dark' ? 'sun' : 'moon'); ?>">
                </i>
            </a>
        </li>
        ...
        <li class="nav-item dropdown dropdown-user">
            ...
            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                <h6 class="dropdown-header"><?php echo e(Auth::user()->username); ?></h6>
                <div class="dropdown-divider"></div>
                <a href="<?php echo e(route('user.show', ['id' => auth()->user()->id])); ?>" class="dropdown-item">
                    <i class="me-50" data-feather="user"></i> <?php echo e(__('locale.Profile')); ?>

                </a>
                
                <a class="dropdown-item" href="#">
                    <i class="me-50" data-feather="settings"></i> <?php echo e(__('locale.Settings')); ?>
                ...
                <?php if(Auth::check()): ?>
                    <a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
                        ...
                        <i class="me-50" data-feather="power"></i> <?php echo e(__('locale.Logout')); ?>
...
<!-- END: Header-->
<?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views/panels/navbar.blade.php ENDPATH**/ ?>