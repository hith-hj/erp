                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-1">
                                            <label class="form-label"
                                                for="vendor"><?php echo e(__('locale.Vendor')); ?></label>
...
unset($__errorArgs, $__bag); ?>>
                                    ...
                                    <div class="col-6">
                                        <div class="mb-1">
                                            <label class="form-label"
                                                for="material_list"><?php echo e(__('locale.Materials')); ?></label>
...
unset($__errorArgs, $__bag); ?>"
                                                placeholder="<?php echo e(__('locale.Quantity')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                placeholder="<?php echo e(__('locale.Cost')); ?>" value="<?php echo e(old('cost')); ?>"
                                    ...
                                    <div class="col-3">
                                        <div class="mb-1">
                                            <label class="form-label"
                                                for="currency"><?php echo e(__('locale.Currency')); ?></label>
...
unset($__errorArgs, $__bag); ?>">
                                                <option value=""><?php echo e(__('locale.Chose')); ?></option>
                                                <option value="0"
                                                    <?php if(old('mark') == 0): ?> selected <?php endif; ?>>
                                                    <?php echo e(__('locale.None')); ?></option>
                                                <option value="1"
                                                    <?php if(old('mark') == 1): ?> selected <?php endif; ?>>
                                                    <?php echo e(__('locale.Audited')); ?></option>
                                                <option value="2"
                                                    <?php if(old('mark') == 2): ?> selected <?php endif; ?>>
                                                    <?php echo e(__('locale.Checked')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-4">
...
unset($__errorArgs, $__bag); ?>">
                                                <option value=""><?php echo e(__('locale.Chose')); ?></option>
                                                <option value="0"
                                                    <?php if(old('level') == 0): ?> selected <?php endif; ?>>
                                                    <?php echo e(__('locale.None')); ?></option>
                                                <option value="1"
                                                    <?php if(old('level') == 1): ?> selected <?php endif; ?>>
                                                    <?php echo e(__('locale.Closed')); ?></option>
                                                <option value="2"
                                                    <?php if(old('level') == 2): ?> selected <?php endif; ?>>
                                                    <?php echo e(__('locale.Secret')); ?></option>
                                            </select>
                                        </div>
                                    </div>
...
<!--/ Edit User Modal -->
<?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views/utils/bill_modal.blade.php ENDPATH**/ ?>