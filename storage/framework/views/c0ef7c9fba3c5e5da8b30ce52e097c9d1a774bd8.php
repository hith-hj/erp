...
<link rel="stylesheet" href="<?php echo e(asset('css/base/plugins/forms/pickers/form-flat-pickr.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('css/base/pages/app-invoice.css')); ?>">
<?php $__env->stopSection(); ?>
    ...
    <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
      <div class="card">
        <div class="card-body">
          ...
          <a class="btn btn-outline-secondary w-100 mb-75" href="<?php echo e(url('app/invoice/print')); ?>" target="_blank"> Print </a>
          <a class="btn btn-outline-secondary w-100 mb-75" href="<?php echo e(url('app/invoice/edit')); ?>"> Edit </a>
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views//content/apps/invoice/app-invoice-preview.blade.php ENDPATH**/ ?>