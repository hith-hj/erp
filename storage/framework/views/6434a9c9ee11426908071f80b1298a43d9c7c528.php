...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('locale.New Client')); ?>
...
<?php $__env->startSection('content'); ?>
    <section>
        <form method="POST" action="<?php echo e(route('client.store')); ?>" class="form form-vertical">
            <?php echo csrf_field(); ?>
            <div class="card row">
                <?php if($errors->any()): ?>
                ...
                <div class="card-header">
                    <h4 class="card-title"><?php echo e(__('locale.New Client')); ?></h4>
                </div>
                <div class="card-body col-12 row clients-repeater">
                    <div data-repeater-list="clients" class="col-12">
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views/main/client/create.blade.php ENDPATH**/ ?>