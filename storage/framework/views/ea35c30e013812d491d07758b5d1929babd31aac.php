  ...
  <div class="row">
    <div class="col-12">
      <div class="card profile-header mb-2">
        ...
        <img
          class="card-img-top"
          src="<?php echo e(asset('images/profile/user-uploads/timeline.jpg')); ?>"
          ...
          <div class="card-body profile-suggestion">
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar me-1">
                <img src="<?php echo e(asset('images/avatars/12-small.png')); ?>" alt="avatar img" height="40" width="40" />
              </div>
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar me-1">
                <img src="<?php echo e(asset('images/avatars/1-small.png')); ?>" alt="avatar" height="40" width="40" />
              </div>
              <div class="profile-user-info">
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar me-1">
                <img src="<?php echo e(asset('images/avatars/10-small.png')); ?>" alt="avatar" height="40" width="40" />
              </div>
              <div class="profile-user-info">
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar me-1">
                <img src="<?php echo e(asset('images/avatars/3-small.png')); ?>" alt="avatar img" height="40" width="40" />
              </div>
              <div class="profile-user-info">
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar me-1">
                <img src="<?php echo e(asset('images/avatars/5-small.png')); ?>" alt="avatar img" height="40" width="40" />
              </div>
              <div class="profile-user-info">
            ...
            <div class="d-flex justify-content-start align-items-center">
              <div class="avatar me-1">
                <img src="<?php echo e(asset('images/avatars/6-small.png')); ?>" alt="avatar img" height="40" width="40" />
              </div>
              <div class="profile-user-info">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="profile-twitter-feed mt-2">
              <div class="d-flex justify-content-start align-items-center mb-1">
                <div class="avatar me-1">
                  <img src="<?php echo e(asset('images/avatars/1-small.png')); ?>" alt="avatar img" height="40" width="40" />
                </div>
                <div class="profile-user-info">
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-start align-items-center mb-1">
              ...
              <div class="avatar me-1">
                <img
                  src="<?php echo e(asset('images/portrait/small/avatar-s-18.jpg')); ?>"
                  alt="avatar img"
                  height="50"
                  width="50"
                />
            ...
            <img
              ...
              src="<?php echo e(asset('images/profile/post-media/2.jpg')); ?>"
              alt="avatar img"
            />
            <!--/ post img -->
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar me-1">
                <img
                  src="<?php echo e(asset('images/portrait/small/avatar-s-22.jpg')); ?>"
                  alt="avatar img"
                  height="50"
                  width="50"
                />
            ...
            <img
              class="img-fluid rounded mb-75"
              src="<?php echo e(asset('images/profile/post-media/25.jpg')); ?>"
              alt="avatar img"
            />
            <!--/ post img -->
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar me-1">
                <img
                  src="<?php echo e(asset('images/portrait/small/avatar-s-15.jpg')); ?>"
                  alt="avatar img"
                  height="50"
                  width="50"
                />
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="#">
                  <img
                    src="<?php echo e(asset('images/profile/user-uploads/user-13.jpg')); ?>"
              ...
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="#">
                  <img
                    src="<?php echo e(asset('images/profile/user-uploads/user-02.jpg')); ?>"
                    class="img-fluid rounded"
                    alt="avatar img"
                  />
                </a>
              ...
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="#">
                  <img
                    src="<?php echo e(asset('images/profile/user-uploads/user-03.jpg')); ?>"
                    class="img-fluid rounded"
                    alt="avatar img"
                  />
                </a>
              ...
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="#">
                  <img
                    src="<?php echo e(asset('images/profile/user-uploads/user-04.jpg')); ?>"
                    class="img-fluid rounded"
                    alt="avatar img"
                  />
                </a>
              ...
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="#">
                  <img
                    src="<?php echo e(asset('images/profile/user-uploads/user-05.jpg')); ?>"
                    class="img-fluid rounded"
                    alt="avatar img"
                  />
                </a>
              ...
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="#">
                  <img
                    src="<?php echo e(asset('images/profile/user-uploads/user-06.jpg')); ?>"
                    class="img-fluid rounded"
                    alt="avatar img"
                  />
                </a>
              ...
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="#">
                  <img
                    src="<?php echo e(asset('images/profile/user-uploads/user-07.jpg')); ?>"
                    class="img-fluid rounded"
                    alt="avatar img"
                  />
                </a>
              ...
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="#">
                  <img
                    src="<?php echo e(asset('images/profile/user-uploads/user-08.jpg')); ?>"
                    class="img-fluid rounded"
                    alt="avatar img"
                  />
                </a>
              ...
              <div class="col-md-4 col-6 profile-latest-img">
                <a href="#">
                  <img
                    src="<?php echo e(asset('images/profile/user-uploads/user-09.jpg')); ?>"
                    class="img-fluid rounded"
                    alt="avatar img"
                  />
                </a>
          ...
          <div class="card-body">
            ...
            <div class="profile-polls-info mt-2">
              ...
              <div class="avatar-group my-1">
                ...
                >
                  <img
                    src="<?php echo e(asset('images/portrait/small/avatar-s-12.jpg')); ?>"
                    alt="Avatar"
                    height="26"
                    width="26"
                  />
                ...
                >
                  <img
                    src="<?php echo e(asset('images/portrait/small/avatar-s-11.jpg')); ?>"
                    alt="Avatar"
                    height="26"
                    width="26"
                  />
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views//content/pages/page-profile.blade.php ENDPATH**/ ?>