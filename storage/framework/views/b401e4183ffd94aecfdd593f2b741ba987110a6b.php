...
<div class="row">
  <div class="col-12">
    <ul class="nav nav-pills mb-2">
      <!-- Account -->
      <li class="nav-item">
        <a class="nav-link active" href="<?php echo e(asset('page/account-settings-account')); ?>">
      ...
      <!-- security -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(asset('page/account-settings-security')); ?>">
...
<?php $__env->startSection('page-script'); ?>
  <!-- Page js files -->
  <script src="<?php echo e(asset(mix('js/scripts/pages/page-account-settings-account.js'))); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views//content/pages/page-account-settings-account.blade.php ENDPATH**/ ?>