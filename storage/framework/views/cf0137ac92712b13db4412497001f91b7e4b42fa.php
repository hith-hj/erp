...
<?php $__env->startSection('page-style'); ?>
  <!-- Page css files -->
  <link rel="stylesheet" href="<?php echo e(asset(mix('css/base/plugins/forms/form-quill-editor.css'))); ?>">
  <link rel="stylesheet" href="<?php echo e(asset(mix('css/base/plugins/extensions/ext-component-toastr.css'))); ?>">
  <link rel="stylesheet" href="<?php echo e(asset(mix('css/base/pages/app-email.css'))); ?>">
<?php $__env->stopSection(); ?>

<!-- Sidebar Area -->
<?php $__env->startSection('content-sidebar'); ?>
<?php echo $__env->make('content/apps/email/app-email-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
    ...
    <ul class="email-media-list">
      <li class="d-flex user-mail mail-read">
        <div class="mail-left pe-50">
          <div class="avatar">
            <img src="<?php echo e(asset('images/portrait/small/avatar-s-20.jpg')); ?>" alt="avatar img holder" />
          </div>
      ...
      <li class="d-flex user-mail">
        <div class="mail-left pe-50">
          <div class="avatar">
            <img src="<?php echo e(asset('images/portrait/small/avatar-s-17.jpg')); ?>" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="form-check">
      ...
      <li class="d-flex user-mail mail-read">
        <div class="mail-left pe-50">
          <div class="avatar">
            <img src="<?php echo e(asset('images/portrait/small/avatar-s-7.jpg')); ?>" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="form-check">
      ...
      <li class="d-flex user-mail mail-read">
        <div class="mail-left pe-50">
          <div class="avatar">
            <img src="<?php echo e(asset('images/portrait/small/avatar-s-5.jpg')); ?>" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="form-check">
      ...
      <li class="d-flex user-mail">
        <div class="mail-left pe-50">
          <div class="avatar">
            <img src="<?php echo e(asset('images/portrait/small/avatar-s-3.jpg')); ?>" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="form-check">
      ...
      <li class="d-flex user-mail">
        <div class="mail-left pe-50">
          <div class="avatar">
            <img src="<?php echo e(asset('images/portrait/small/avatar-s-8.jpg')); ?>" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="form-check">
      ...
      <li class="d-flex user-mail mail-read">
        <div class="mail-left pe-50">
          <div class="avatar">
            <img src="<?php echo e(asset('images/portrait/small/avatar-s-11.jpg')); ?>" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="form-check">
      ...
      <li class="d-flex user-mail mail-read">
        <div class="mail-left pe-50">
          <div class="avatar">
            <img src="<?php echo e(asset('images/portrait/small/avatar-s-10.jpg')); ?>" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="form-check">
      ...
      <li class="d-flex user-mail mail-read">
        <div class="mail-left pe-50">
          <div class="avatar">
            <img src="<?php echo e(asset('images/portrait/small/avatar-s-6.jpg')); ?>" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="form-check">
      ...
      <li class="d-flex user-mail">
        <div class="mail-left pe-50">
          <div class="avatar">
            <img src="<?php echo e(asset('images/portrait/small/avatar-s-9.jpg')); ?>" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="form-check">
      ...
      <li class="d-flex user-mail">
        <div class="mail-left pe-50">
          <div class="avatar">
            <img src="<?php echo e(asset('images/portrait/small/avatar-s-20.jpg')); ?>" alt="Generic placeholder image" />
          </div>
          <div class="user-action">
            <div class="form-check">
          ...
          <div class="card-footer">
            <div class="mail-attachments">
              ...
              <div class="d-flex flex-column">
                <a href="#" class="mb-50">
                  <img src="<?php echo e(asset('images/icons/doc.png')); ?>" class="me-25" alt="png" height="18" />
                  <small class="text-muted fw-bolder">interdum.docx</small>
                </a>
                <a href="#">
                  <img src="<?php echo e(asset('images/icons/jpg.png')); ?>" class="me-25" alt="png" height="18" />
...
<?php $__env->startSection('page-script'); ?>
  <!-- Page js files -->
  <script src="<?php echo e(asset(mix('js/scripts/pages/app-email.js'))); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views//content/apps/email/app-email.blade.php ENDPATH**/ ?>