<?php $__env->startSection('title', 'Kanban'); ?>

<?php $__env->startSection('vendor-style'); ?>
  <!-- Vendor css files -->
  <link rel="stylesheet" href="<?php echo e(asset(mix('vendors/css/jkanban/jkanban.min.css'))); ?>">
...
<?php $__env->startSection('page-style'); ?>
  ...
  <link rel="stylesheet" href="<?php echo e(asset(mix('css/base/pages/app-kanban.css'))); ?>">
<?php $__env->stopSection(); ?>
            ...
            <div class="tab-pane tab-pane-activity pb-1 fade" id="tab-activity" role="tabpanel">
              ...
              <div class="d-flex align-items-start mb-1">
                <div class="avatar my-0 ms-0 me-50">
                  <img src="<?php echo e(asset('images/portrait/small/avatar-s-6.jpg')); ?>" alt="Avatar" height="32" />
                </div>
                <div class="more-info">
                  <p class="mb-0">
              ...
              <div class="d-flex align-items-start mb-1">
                <div class="avatar my-0 ms-0 me-50">
                  <img src="<?php echo e(asset('images/portrait/small/avatar-s-2.jpg')); ?>" alt="Avatar" height="32" />
                </div>
                <div class="more-info">
                  <p class="mb-0">
              ...
              <div class="d-flex align-items-start mb-1">
                <div class="avatar my-0 ms-0 me-50">
                  <img src="<?php echo e(asset('images/portrait/small/avatar-s-1.jpg')); ?>" alt="Avatar" height="32" />
                </div>
                <div class="more-info">
              ...
              <div class="d-flex align-items-start mb-1">
                <div class="avatar my-0 ms-0 me-50">
                  <img src="<?php echo e(asset('images/portrait/small/avatar-s-4.jpg')); ?>" alt="Avatar" height="32" />
                </div>
                <div class="more-info">
                  <p class="mb-0">
...
<?php $__env->startSection('vendor-script'); ?>
  <!-- Vendor js files -->
  <script src="<?php echo e(asset(mix('vendors/js/jkanban/jkanban.min.js'))); ?>"></script>
...
<?php $__env->startSection('page-script'); ?>
  <!-- Page js files -->
  <script src="<?php echo e(asset(mix('js/scripts/pages/app-kanban.js'))); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views//content/apps/kanban/app-kanban.blade.php ENDPATH**/ ?>