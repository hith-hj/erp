...
<?php $__env->startSection('title', 'Two Steps Cover'); ?>
  ...
  <div class="auth-inner row m-0">
    ...
    <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
        <div class="w-100 d-lg-flex align-items-center justify-content-center px-5">
          ...
          <img class="img-fluid" src="<?php echo e(asset('images/illustration/two-steps-verification-illustration-dark.svg')); ?>" alt="two steps verification" />
          <?php else: ?>
          <img class="img-fluid" src="<?php echo e(asset('images/illustration/two-steps-verification-illustration.svg')); ?>" alt="two steps verification" />
          <?php endif; ?>
        </div>
    </div>
    <!-- /Left Text-->
    ...
    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
      <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
        ...
        <form class="mt-2" action="<?php echo e(asset('/')); ?>" method="GET">
...
<script src="<?php echo e(asset(mix('js/scripts/pages/auth-two-steps.js'))); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/fullLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views//content/authentication/auth-two-steps-cover.blade.php ENDPATH**/ ?>