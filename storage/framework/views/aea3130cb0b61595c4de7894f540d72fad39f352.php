...
<form id="sale_form" method="POST" action="<?php echo e(route('sale.store')); ?>" class="form form-vertical">
    <?php echo csrf_field(); ?>
                ...
                <div class="card"
                    ...
                    <div class="card-body pb-0">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-1">
                                    <label class="form-label" for="client"><?php echo e(__('locale.Client')); ?></label>
