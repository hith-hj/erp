...
unset($__errorArgs, $__bag); ?>" name="code"
                    ...
                    <div class="col-4">
                        <div class="mb-1">
                            ...
                            <input type="number" id="rate" name="rate_to_default"
                                step="0.001" min="0.001" max="100000"
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="<?php echo e(__('locale.Rate')); ?>" value="<?php echo e(old('rate_to_default')); ?>" required
                                tabindex="1" />
                        </div>
                    </div>
                </div>
