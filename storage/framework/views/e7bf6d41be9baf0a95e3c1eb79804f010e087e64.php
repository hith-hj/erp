    ...
    <div class="modal-content">
      ...
      <div class="modal-body pb-5 px-sm-5 mx-50">
        ...
        <div class="d-flex justify-content-center my-2 py-50">
          <img class="img-fluid" src="<?php echo e(asset('images/icons/qrcode.png')); ?>" width="122" alt="QR Code" />
        </div>
...
<!-- / add authentication sms modal-->
<?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views/content/_partials/_modals/modal-two-factor-auth.blade.php ENDPATH**/ ?>