                                ...
                                <div class="col-12">
                                    <div class="mb-1">
                                        <label class="form-label"> 
                                            <?php echo e(__('locale.Set as default')); ?> 
                                        </label>
                                            ...
                                            <div class="form-check form-switch form-check-success">
                                                ...
                                                <label class="form-check-label" for="defaultInventory">
                                                    <span class="switch-icon-left px-1">
                                                        <?php echo e(__('locale.Is Default')); ?>

                                                    </span>
                                                    <span class="switch-icon-right px-1">
                                                        <?php echo e(__('locale.Not default')); ?>
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <select id="material_list" name="material_id" class="form-select"
                                                        ...
                                                        <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($material->type == 1 || ($material->type == 2 && $material->manufactureModel->count() > 0)): ?>
