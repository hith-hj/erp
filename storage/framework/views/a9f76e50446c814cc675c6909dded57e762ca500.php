...
<?php $__env->startSection('vendor-style'); ?>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/css/extensions/jstree.min.css')); ?>">
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-style'); ?>
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset(mix('css/base/plugins/extensions/ext-component-tree.css'))); ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset(mix('css/base/pages/app-file-manager.css'))); ?>">
<?php $__env->stopSection(); ?>


<?php $__env->startSection('content-sidebar'); ?>
<?php echo $__env->make('content/apps/fileManager/app-file-manager-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
      ...
      <div class="row">
          ...
          <div class="card shadow-none border cursor-pointer">
            <div class="card-body">
              <div class="d-flex justify-content-between">
                <img src="<?php echo e(asset('images/icons/drive.png')); ?>" alt="google drive" height="38" />
        ...
        <div class="col-lg-3 col-md-6 col-12">
          <div class="card shadow-none border cursor-pointer">
            <div class="card-body">
              <div class="d-flex justify-content-between">
                <img src="<?php echo e(asset('images/icons/dropbox.png')); ?>" alt="dropbox" height="38" />
                <div class="dropdown-items-wrapper">
                  <i
                    data-feather="more-vertical"
        ...
        <div class="col-lg-3 col-md-6 col-12">
          <div class="card shadow-none border cursor-pointer">
            <div class="card-body">
              <div class="d-flex justify-content-between">
                <img src="<?php echo e(asset('images/icons/onedrivenew.png')); ?>" alt="icloud" height="38" class="p-25" />
                <div class="dropdown-items-wrapper">
                  <i
                    data-feather="more-vertical"
        ...
        <div class="col-lg-3 col-md-6 col-12">
          <div class="card shadow-none border cursor-pointer">
            <div class="card-body">
              <div class="d-flex justify-content-between">
                <img src="<?php echo e(asset('images/icons/icloud-1.png')); ?>" alt="icloud" height="38" class="p-25" />
                <div class="dropdown-items-wrapper">
                  <span
                    data-feather="more-vertical"
    ...
    <div class="view-container">
      ...
      <div class="card file-manager-item file">
        ...
        <div class="card-img-top file-logo-wrapper">
          ...
          <div class="d-flex align-items-center justify-content-center w-100">
            <img src="<?php echo e(asset('images/icons/jpg.png')); ?>" alt="file-icon" height="35" />
          </div>
        </div>
        <div class="card-body">
          <div class="content-wrapper">
      ...
      <div class="card file-manager-item file">
        ...
        <div class="card-img-top file-logo-wrapper">
          ...
          <div class="d-flex align-items-center justify-content-center w-100">
            <img src="<?php echo e(asset('images/icons/doc.png')); ?>" alt="file-icon" height="35" />
          </div>
        </div>
        <div class="card-body">
          <div class="content-wrapper">
      ...
      <div class="card file-manager-item file">
        ...
        <div class="card-img-top file-logo-wrapper">
          ...
          <div class="d-flex align-items-center justify-content-center w-100">
            <img src="<?php echo e(asset('images/icons/txt.png')); ?>" alt="file-icon" height="35" />
          </div>
        </div>
        <div class="card-body">
          <div class="content-wrapper">
      ...
      <div class="card file-manager-item file">
        ...
        <div class="card-img-top file-logo-wrapper">
          ...
          <div class="d-flex align-items-center justify-content-center w-100">
            <img src="<?php echo e(asset('images/icons/json.png')); ?>" alt="file-icon" height="35" />
          </div>
        </div>
        <div class="card-body">
          <div class="content-wrapper">
        ...
        <div class="tab-content" id="myTabContent">
          <div class="tab-pane fade show active" id="details-tab" role="tabpanel" aria-labelledby="details-tab">
            <div class="d-flex flex-column justify-content-center align-items-center py-5">
              <img src="<?php echo e(asset('images/icons/js.png')); ?>" alt="file-icon" height="64" />
          ...
          <div class="tab-pane fade" id="activity-tab" role="tabpanel" aria-labelledby="activity-tab">
            ...
            <div class="d-flex align-items-center mb-2">
              <div class="avatar avatar-sm me-50">
                <img src="<?php echo e(asset('images/avatars/5-small.png')); ?>" alt="avatar" width="28" />
              </div>
              <div class="more-info">
                <p class="mb-0">
            ...
            <div class="d-flex align-items-center">
              <div class="avatar avatar-sm me-50">
                <img src="<?php echo e(asset('images/portrait/small/avatar-s-1.jpg')); ?>" alt="Avatar" width="28" />
              </div>
              <div class="more-info">
                <p class="mb-0">
            ...
            <div class="d-flex align-items-start">
              ...
              <div class="more-info">
                ...
                <img src="<?php echo e(asset('images/icons/js.png')); ?>" alt="Avatar" class="me-50" height="24" />
...
<script src="<?php echo e(asset('vendors/js/extensions/jstree.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views//content/apps/fileManager/app-file-manager.blade.php ENDPATH**/ ?>