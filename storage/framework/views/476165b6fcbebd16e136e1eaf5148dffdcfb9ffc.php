          ...
          <div class="row pricing-card">
            ...
            <div class="col-12 col-lg-4">
              <div class="card basic-pricing border text-center shadow-none">
                <div class="card-body">
                  <img src="<?php echo e(asset('images/illustration/Pot1.svg')); ?>" class="mb-2 mt-5" alt="svg img" />
                  <h3>Basic</h3>
            ...
            <div class="col-12 col-lg-4">
              <div class="card standard-pricing border-primary text-center shadow-none">
                <div class="card-body">
                  ...
                  <img src="<?php echo e(asset('images/illustration/Pot2.svg')); ?>" class="mb-1" alt="svg img" />
                  <h3>Standard</h3>
            ...
            <div class="col-12 col-lg-4">
              <div class="card enterprise-pricing border text-center shadow-none">
                <div class="card-body">
                  <img src="<?php echo e(asset('images/illustration/Pot3.svg')); ?>" class="mb-2" alt="svg img" />
                  <h3>Enterprise</h3>
...
<!-- / pricing modal  -->
<?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views/content/_partials/_modals/modal-pricing.blade.php ENDPATH**/ ?>