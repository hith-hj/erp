...
<!-- Page css files -->
<link rel="stylesheet" href="<?php echo e(asset(mix('css/base/plugins/extensions/ext-component-sliders.css'))); ?>">
<link rel="stylesheet" href="<?php echo e(asset(mix('css/base/pages/app-ecommerce.css'))); ?>">
...
<?php echo $__env->make('content/apps/ecommerce/app-ecommerce-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
<section id="ecommerce-products" class="grid-view">
  <div class="card ecommerce-card">
    <div class="item-img text-center">
      <a href="<?php echo e(url('app/ecommerce/details')); ?>">
        <img
          class="img-fluid card-img-top"
          src="<?php echo e(asset('images/pages/eCommerce/1.png')); ?>"
          alt="img-placeholder"
      /></a>
    </div>
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="<?php echo e(url('app/ecommerce/details')); ?>">Apple Watch Series 5</a>
  ...
  <div class="card ecommerce-card">
    <div class="item-img text-center">
      <a href="<?php echo e(url('app/ecommerce/details')); ?>">
        <img
          class="img-fluid card-img-top"
          src="<?php echo e(asset('images/pages/eCommerce/2.png')); ?>"
          alt="img-placeholder"
        />
      </a>
    </div>
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="<?php echo e(url('app/ecommerce/details')); ?>">Apple iPhone 11 (64GB, Black)</a>
        <span class="card-text item-company">By <a href="#" class="company-name">Apple</a></span>
      </h6>
      <p class="card-text item-description">
  ...
  <div class="card ecommerce-card">
    <div class="item-img text-center">
      <a href="<?php echo e(url('app/ecommerce/details')); ?>"
        ><img
          class="img-fluid card-img-top"
          src="<?php echo e(asset('images/pages/eCommerce/3.png')); ?>"
          alt="img-placeholder"
      /></a>
    </div>
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="<?php echo e(url('app/ecommerce/details')); ?>">Apple iMac 27-inch</a>
        <span class="card-text item-company">By <a href="#" class="company-name">Apple</a></span>
      </h6>
      <p class="card-text item-description">
  ...
  <div class="card ecommerce-card">
    <div class="item-img text-center">
      <a href="<?php echo e(url('app/ecommerce/details')); ?>">
        <img
          class="img-fluid card-img-top"
          src="<?php echo e(asset('images/pages/eCommerce/4.png')); ?>"
          alt="img-placeholder"
      /></a>
    </div>
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="<?php echo e(url('app/ecommerce/details')); ?>">OneOdio A71 Wired Headphones</a>
  ...
  <div class="card ecommerce-card">
    <div class="item-img text-center">
      <a href="<?php echo e(url('app/ecommerce/details')); ?>">
        <img
          class="img-fluid card-img-top"
          src="<?php echo e(asset('images/pages/eCommerce/5.png')); ?>"
          alt="img-placeholder"
        />
      </a>
    </div>
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="<?php echo e(url('app/ecommerce/details')); ?>">
  ...
  <div class="card ecommerce-card">
    <div class="item-img text-center">
      <a href="<?php echo e(url('app/ecommerce/details')); ?>">
        <img
          class="img-fluid card-img-top"
          src="<?php echo e(asset('images/pages/eCommerce/6.png')); ?>"
          alt="img-placeholder"
        />
      </a>
    </div>
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="<?php echo e(url('app/ecommerce/details')); ?>"> Switch Pro Controller </a>
  ...
  <div class="card ecommerce-card">
    <div class="item-img text-center">
      <a href="<?php echo e(url('app/ecommerce/details')); ?>">
        <img
          class="img-fluid card-img-top"
          src="<?php echo e(asset('images/pages/eCommerce/7.png')); ?>"
          alt="img-placeholder"
        />
      </a>
    </div>
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="<?php echo e(url('app/ecommerce/details')); ?>"> Google - Google Home - White/Slate fabric </a>
  ...
  <div class="card ecommerce-card">
    <div class="item-img text-center">
      <a href="<?php echo e(url('app/ecommerce/details')); ?>">
        <img
          class="img-fluid card-img-top"
          src="<?php echo e(asset('images/pages/eCommerce/8.png')); ?>"
          alt="img-placeholder"
        />
      </a>
    </div>
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="<?php echo e(url('app/ecommerce/details')); ?>"> Sony 4K Ultra HD LED TV </a>
        <span class="card-text item-company">By <a href="#" class="company-name">Apple</a></span>
      </h6>
      <p class="card-text item-description">
  ...
  <div class="card ecommerce-card">
    <div class="item-img text-center">
      <a href="<?php echo e(url('app/ecommerce/details')); ?>">
        <img
          class="img-fluid card-img-top"
          src="<?php echo e(asset('images/pages/eCommerce/9.png')); ?>"
          alt="img-placeholder"
        />
      </a>
    </div>
    <div class="card-body">
      ...
      <h6 class="item-name">
        <a class="text-body" href="<?php echo e(url('app/ecommerce/details')); ?>"> OnePlus 7 Pro </a>
...
<!-- Vendor js files -->
<script src="<?php echo e(asset(mix('vendors/js/extensions/wNumb.min.js'))); ?>"></script>
...
<!-- Page js files -->
<script src="<?php echo e(asset(mix('js/scripts/pages/app-ecommerce.js'))); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/detachedLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views//content/apps/ecommerce/app-ecommerce-shop.blade.php ENDPATH**/ ?>