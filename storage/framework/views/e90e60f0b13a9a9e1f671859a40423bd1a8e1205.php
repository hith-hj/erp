        ...
        <table class="table">
          ...
          <tbody>
            <tr>
              <td>
                <img
                  src="<?php echo e(asset('images/icons/angular.svg')); ?>"
                  class="me-75"
                  height="20"
                  width="20"
                  alt="Angular"
            ...
            <tr>
              <td>
                <img
                  src="<?php echo e(asset("images/icons/react.svg")); ?>"
                  class="me-75"
                  height="20"
                  width="20"
                  alt="React"
            ...
            <tr>
              <td>
                <img
                  src="<?php echo e(asset('images/icons/vuejs.svg')); ?>"
                  class="me-75"
                  height="20"
                  width="20"
                  alt="Vuejs"
            ...
            <tr>
              <td>
                <img
                  src="<?php echo e(asset('images/icons/bootstrap.svg')); ?>"
                  class="me-75"
                  height="20"
                  width="20"
                  alt="Bootstrap"
        ...
        <table class="table">
          ...
          <tbody>
            <tr class="table-default">
              <td>
                <img
                  src="<?php echo e(asset('images/icons/figma.svg')); ?>"
                  class="me-75"
                  height="20"
                  width="20"
                  alt="Figma"
    ...
    <div class="table-responsive">
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            <td>
              <img src="<?php echo e(asset('images/icons/react.svg')); ?>" class="me-75" height="20" width="20" alt="React" />
              <span class="fw-bold">React Project</span>
            </td>
            <td>Ronald Frest</td>
            <td>
          ...
          <tr>
            <td>
              <img src="<?php echo e(asset('images/icons/vuejs.svg')); ?>" class="me-75" height="20" width="20" alt="Vuejs" />
              <span class="fw-bold">Vuejs Project</span>
            </td>
            <td>Jack Obes</td>
            <td>
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views//content/table/table-bootstrap/table-bootstrap.blade.php ENDPATH**/ ?>