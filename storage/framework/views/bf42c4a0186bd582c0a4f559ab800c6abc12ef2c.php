...
<?php $__env->startSection('vendor-style'); ?>
  ...
  <link rel="stylesheet" href="<?php echo e(asset(mix('vendors/css/extensions/dragula.min.css'))); ?>">
...
<?php $__env->startSection('page-style'); ?>
  ...
  <link rel="stylesheet" href="<?php echo e(asset(mix('css/base/pages/app-todo.css'))); ?>">
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content-sidebar'); ?>
<?php echo $__env->make('content/apps/todo/app-todo-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
      ...
      <li class="todo-item">
        <div class="todo-title-wrapper">
          ...
          <div class="todo-item-action">
            ...
            <div class="avatar">
              <img
                src="<?php echo e(asset('images/portrait/small/avatar-s-17.jpg')); ?>"
                alt="user-avatar"
                height="32"
                width="32"
              />
          ...
          <div class="action-tags">
            ...
            <div class="mb-1 position-relative">
              ...
              <select class="select2 form-select" id="task-assigned" name="task-assigned">
                <option
                  data-img="<?php echo e(asset('images/portrait/small/avatar-s-3.jpg')); ?>"
                  value="Phill Buffer"
                  selected
                >
                  Phill Buffer
                </option>
                <option data-img="<?php echo e(asset('images/portrait/small/avatar-s-1.jpg')); ?>" value="Chandler Bing">
                  Chandler Bing
                </option>
                <option data-img="<?php echo e(asset('images/portrait/small/avatar-s-4.jpg')); ?>" value="Ross Geller">
                  Ross Geller
                </option>
                <option data-img="<?php echo e(asset('images/portrait/small/avatar-s-6.jpg')); ?>" value="Monica Geller">
                  Monica Geller
                </option>
                <option data-img="<?php echo e(asset('images/portrait/small/avatar-s-2.jpg')); ?>" value="Joey Tribbiani">
                  Joey Tribbiani
                </option>
                <option data-img="<?php echo e(asset('images/portrait/small/avatar-s-11.jpg')); ?>" value="Rachel Green">
                  Rachel Green
                </option>
              </select>
            </div>
...
<!-- vendor js files -->
  ...
  <script src="<?php echo e(asset(mix('vendors/js/extensions/dragula.min.js'))); ?>"></script>
...
<?php $__env->startSection('page-script'); ?>
  <!-- Page js files -->
  <script src="<?php echo e(asset(mix('js/scripts/pages/app-todo.js'))); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views//content/apps/todo/app-todo.blade.php ENDPATH**/ ?>