...
<?php $__env->startSection('title', 'Advance Card'); ?>
...
<div class="row match-height">
      ...
      <div class="card-body">
        ...
        <div class="employee-task d-flex justify-content-between align-items-center">
          <div class="d-flex flex-row">
            <div class="avatar me-75">
              <img
                src="<?php echo e(asset('images/portrait/small/avatar-s-16.jpg')); ?>"
                class="rounded"
                width="42"
                height="42"
                alt="Avatar"
        ...
        <div class="employee-task d-flex justify-content-between align-items-center">
          <div class="d-flex flex-row">
            <div class="avatar me-75">
              <img
                src="<?php echo e(asset('images/portrait/small/avatar-s-13.jpg')); ?>"
                class="rounded"
                width="42"
                height="42"
                alt="Avatar"
      ...
      <div class="card-body">
        ...
        <div class="avatar-group">
          ...
          <div
            ...
            class="avatar pull-up"
          >
            <img src="<?php echo e(asset('images/portrait/small/avatar-s-20.jpg')); ?>" alt="Avatar" width="33" height="33" />
          </div>
          <div
            data-bs-toggle="tooltip"
            data-popup="tooltip-custom"
  ...
  <div class="col-lg-4 col-md-6 col-12">
    <div class="card card-profile">
      <img
        src="<?php echo e(asset('images/banner/banner-12.jpg')); ?>"
      ...
      <div class="card-body">
        <div class="profile-image-wrapper">
          <div class="profile-image">
            <div class="avatar">
              <img src="<?php echo e(asset('images/portrait/small/avatar-s-9.jpg')); ?>" alt="Profile Picture" />
            </div>
          </div>
        </div>
        <h3>Curtis Stone</h3>
          ...
          <li class="timeline-item">
            ...
            <div class="timeline-event">
              ...
              <div class="d-flex flex-row align-items-center">
                <img class="me-1" src="<?php echo e(asset('images/icons/json.png')); ?>" alt="data.json" height="23" />
      ...
      <div class="card-header">
        <div class="d-flex align-items-center">
          <div class="avatar me-2">
            <img src="<?php echo e(asset('images/portrait/small/avatar-s-20.jpg')); ?>" alt="Avatar" width="34" height="34" />
    ...
    <div class="card card-app-design">
      <div class="card-body">
        ...
        <div class="design-group">
          ...
          <div class="avatar">
            <img src="<?php echo e(asset('images/portrait/small/avatar-s-9.jpg')); ?>" width="34" height="34" alt="Avatar" />
          </div>
          <div class="avatar bg-light-danger">
            <div class="avatar-content">PI</div>
          </div>
          <div class="avatar">
            <img src="<?php echo e(asset('images/portrait/small/avatar-s-14.jpg')); ?>" width="34" height="34" alt="Avatar" />
          </div>
          <div class="avatar">
            <img src="<?php echo e(asset('images/portrait/small/avatar-s-20.jpg')); ?>" width="34" height="34" alt="Avatar" />
          </div>
...
<?php $__env->startSection('page-script'); ?>
  <script src="<?php echo e(asset(mix('js/scripts/cards/card-advance.js'))); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\96393\Desktop\y1s\erp_v1\resources\views//content/cards/card-advance.blade.php ENDPATH**/ ?>